export default {
  ...
  agent: {
    ...
    editor: {
      ...
      retrieveThenGenerateDesc: "迭代式检索，根据模型回答需要逐步检索知识库内容",
      ragIterateSettings: "迭代配置",
      ragMaxRounds: "最大迭代轮数",
      ragMaxRoundsTip: "最大检索生成迭代次数（建议1-6轮）",
      ragIterate: {
        stepCompleted: '答案已生成',
        stepRetrieving: '正在检索知识',
        round: '第 {round} 轮',
        query: '检索查询',
        chunksFound: '找到 {count} 个文档分片',
      },
      model: "模型",
