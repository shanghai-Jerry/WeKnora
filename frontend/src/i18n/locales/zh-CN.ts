export default {
  ...
  chat: {
    ...
    graphHeader: "知识图谱（{nodeCount}个实体，{relCount}条关系）",
    graphNodes: "实体节点",
    graphRelations: "实体关系",
    chunkIdLabel: "片段ID:",
    ...
    modelCompareTitle: "多模型对比",
    modelCompareDesc: "选择多个模型对比回答效果",
    compareQueryPlaceholder: "输入问题...",
    compareUseKnowledge: "使用知识库",
    compareButton: "开始对比",
    compareSelectModels: "选择要对比的模型",
    compareGenerating: "生成中...",
    compareEnterQuery: "请输入问题后点击「开始对比」",
    compareSelectModelHint: "请至少选择一个模型",
    compareReferences: "引用文档 ({count} 篇)",
    compareQueryRequired: "请输入问题",
    compareNoModelSelected: "请至少选择一个模型",
    addModel: "添加模型",
    noMoreModels: "没有更多模型可选",
    selectAgent: "选择智能体",
    selectKnowledge: "选择知识库（可选）",
    selectKnowledgeBase: "选择知识库",
    clearConversation: "清空对话",
    conversationCleared: "对话已清空",
    you: "你",
    pipelineStages: "Pipeline 阶段",
    queryRewritten: "Query 重写",
    originalQuery: "原始 Query",
    rewrittenQuery: "重写后 Query",
  ...
  agent: {
    ...
    editor: {
      ...
      intentExploreModel: "意图探索模型",
      intentExploreModelPlaceholder: "留空使用对话模型",
      enableRewrite: "问题改写",
  ...
  agentEditor: {
    ...
    desc: {
      ...
      queryIntentExplore: "将查询意图拆分为多路并行检索，提升复杂问题的召回率",
      intentExploreModel: "意图探索所使用的模型，为空则使用对话中的模型",
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      yuque: "同步语雀知识库中的文档",
      mysql: "查询MySQL数据库中的数据",
      postgresql: "查询PostgreSQL数据库中的数据",
      sqlite: "查询SQLite数据库中的数据",
    },
    field: {
      appId: "App ID",
  ...
  queryParam: {
    ...
    menuItem: "查询参数设置",
    empty: "暂未设置查询参数",
    emptyHint: "添加参数后，AI 生成 SQL 时会自动注入 WHERE 条件",
    fieldName: "字段名",
    fieldNamePlaceholder: "例如：user_id",
    fieldValue: "字段值",
    fieldValuePlaceholder: "例如：123456",
    fieldDescription: "字段描述",
    fieldDescriptionPlaceholder: "例如：当前登录用户的ID",
    add: "添加参数",
    remove: "移除参数",
    clearAll: "清空全部",
  },
