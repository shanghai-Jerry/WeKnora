...
/example\.(net|org)/`,
  ...
  agentEditor: {
    ...
    desc: {
      ...
      queryIntentExplore: 'Разделение запроса на несколько параллельных путей поиска для улучшения полноты сложных запросов',
      intentExploreModel: 'Модель для исследования намерений, если не указана — используется модель чата',
