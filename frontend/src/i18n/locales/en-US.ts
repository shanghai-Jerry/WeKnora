export default {
  ...
  agent: {
    ...
    editor: {
      ...
      enableQueryIntentExplore: 'Multi-path Retrieval',
      intentExploreModel: 'Intent Explore Model',
      intentExploreModelPlaceholder: 'Leave empty to use chat model',
...
\
  ...
  chat: {
    ...
    graphHeader: 'Knowledge Graph ({nodeCount} entities, {relCount} relations)',
    graphNodes: 'Entity Nodes',
    graphRelations: 'Entity Relations',
    ...
    modelCompareTitle: 'Model Comparison',
    modelCompareDesc: 'Compare responses from multiple models',
    compareQueryPlaceholder: 'Enter question...',
    compareUseKnowledge: 'Use Knowledge Base',
    compareButton: 'Start Comparison',
    compareSelectModels: 'Select models to compare',
    compareGenerating: 'Generating...',
    compareEnterQuery: 'Enter a question and click "Start Comparison"',
    compareSelectModelHint: 'Please select at least one model',
    compareReferences: 'Referenced documents ({count})',
    compareQueryRequired: 'Please enter a question',
    compareNoModelSelected: 'Please select at least one model',
    addModel: 'Add Model',
    noMoreModels: 'No more models available',
    selectAgent: 'Select Agent',
    selectKnowledge: 'Select Knowledge Base (Optional)',
    selectKnowledgeBase: 'Select Knowledge Base',
    clearConversation: 'Clear Conversation',
    conversationCleared: 'Conversation cleared',
    you: 'You',
    pipelineStages: 'Pipeline Stages',
    queryRewritten: 'Query Rewrite',
  ...
  agentEditor: {
    ...
    desc: {
      ...
      queryIntentExplore: 'Split query intent into parallel retrieval paths for better recall on complex questions',
      intentExploreModel: 'Model used for intent explore; falls back to chat model if empty',
    ...
    tools: {
      ...
      sqlQuery: 'SQL Query',
      sqlQueryDesc: 'Query external databases (MySQL, etc.)',
      dataAnalysis: 'Data Analysis',
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      postgresql: 'Query data from PostgreSQL databases',
      sqlite: 'Query data from SQLite databases',
    },
    field: {
      appId: 'App ID',
  ...
  queryParam: {
    title: 'Query Constraint Parameters',
    menuItem: 'Query Params',
    empty: 'No query parameters set',
    emptyHint: 'Add parameters to inject WHERE conditions into AI-generated SQL',
    fieldName: 'Field Name',
    fieldNamePlaceholder: 'e.g. user_id',
    fieldValue: 'Field Value',
    fieldValuePlaceholder: 'e.g. 123456',
    fieldDescription: 'Description',
    fieldDescriptionPlaceholder: 'e.g. Current logged-in user ID',
    add: 'Add Parameter',
    remove: 'Remove',
    clearAll: 'Clear All',
  },
