export default {
  ...
  agent: {
    ...
    editor: {
      ...
      enableQueryIntentExplore: "다중 경로 검색",
      intentExploreModel: "의도 탐색 모델",
      intentExploreModelPlaceholder: "비워두면 대화 모델 사용",
  ...
  agentEditor: {
    ...
    desc: {
      ...
      queryIntentExplore: '쿼리 의도를 여러 병렬 검색 경로로 분할하여 복잡한 질문의 재현율 향상',
      intentExploreModel: '의도 탐색에 사용할 모델, 비워두면 대화 모델 사용',
