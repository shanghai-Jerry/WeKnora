...
// PipelineStages stores query understanding and intent explore data
// Used for history display after page refresh
type PipelineStages map[string]interface{}

// Value implements the driver.Valuer interface for database serialization
func (p PipelineStages) Value() (driver.Value, error) {
	if p == nil {
...
func (p *PipelineStages) Scan(value interface{}) error {
	if value == nil {
		*p = make(PipelineStages)
		return nil
	}
	var b []byte
	switch v := value.(type) {
...
type Message struct {
	...
	// PipelineStages stores query understanding and intent explore data
	// This includes query rewriting, intent classification, query expansion, etc.
	// Stored for history display after page refresh
	PipelineStages PipelineStages `json:"pipeline_stages,omitempty" gorm:"type:jsonb,column:pipeline_stages"`
